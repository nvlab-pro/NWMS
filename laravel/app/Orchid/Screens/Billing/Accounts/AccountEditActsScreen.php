...
use App\Orchid\Layouts\Billings\Accounts\AccountActsTable;
...
class AccountEditActsScreen extends Screen
{
    private $whId;
    ...
    public function query($whId): iterable
    {
        ...
        if (isset($resWhList->wh_id)) {
            ...
            $actsList = rwBillingAct::where('ba_wh_id', $this->whId)
    ...
    {
        return CustomTranslator::get('Акты');
    }
