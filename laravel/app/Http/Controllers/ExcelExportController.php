...
class ExcelExportController extends Controller
{
    ...
    private function dummyData(): array
    {
        ...
        return array_merge([
            ...
            '[offer_id]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_id]']),
            '[offer_num]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_num]']),
            '[offer_name]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_name]']),
            '[offer_article]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_article]']),
            '[offer_qty]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_qty]']),
            '[offer_sku]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_sku]']),
            '[offer_oc_price]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_oc_price]']),
            '[offer_price]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_price]']),
            '[offer_dimension_x]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_dimension_x]']),
            '[offer_dimension_y]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_dimension_y]']),
            '[offer_dimension_z]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_dimension_z]']),
            '[offer_weight]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_weight]']),
            '[offer_sum]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_sum]']),

            '[offer_part_num]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_num]']),
            '[offer_part_id]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_id]']),
            '[offer_part_name]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_name]']),
            '[offer_part_article]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_article]']),
            '[offer_part_sku]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_sku]']),
            '[offer_part_qty]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_qty]']),
            '[offer_part_oc_price]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_oc_price]']),
            '[offer_part_price]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_price]']),
            '[offer_part_production_date]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_production_date]']),
            '[offer_part_expiration_date]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_expiration_date]']),
            '[offer_part_batch]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_batch]']),
            '[offer_part_dimension_x]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_dimension_x]']),
            '[offer_part_dimension_y]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_dimension_y]']),
            '[offer_part_dimension_z]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_dimension_z]']),
            '[offer_part_weight]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_weight]']),
            '[offer_part_sum]' => new ExcelParam(CellSetterArrayValue::class, $tags['[offer_part_sum]']),
        ],
            $customerTags,
            $senderTags,
            $dsTags,
