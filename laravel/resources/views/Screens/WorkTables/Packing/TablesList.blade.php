        ...
        <div style="margin: 10px 0px 10px 10px;">
                ...
                @foreach($dbTablesList as $table)
                    ...
                    @php
                        ...
                        if (isset($arBusyTables[$table->pl_id]) && $arBusyTables[$table->pl_id] !== false) {
                                ...
                                $tableOrderId = $arBusyTables[$table->pl_id]['order_id'];
                                $whName = $arBusyTables[$table->pl_id]['wh_client_name'];
                        }
                    @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($bgcolor == 'tableButtonNullOffers')
                                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                            ...
                                            <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0m-9 8c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4"
                                                  style="color: #5e5d63;"/>
                                            <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7M11 12h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1"
                                                  style="color: #f64747;"/>
                                        </svg>
                                    @endif
                                </td>
                                <td style="padding-left: 20px;">
                                    ...
                                    <div class="tableButtonText">
                                        ...
                                        @else
                                            <span class="tableButtonText2">{{ CustomTranslator::get('Заказ') }} <b>{{ $tableOrderId }}</b> {{ CustomTranslator::get('упаковывается') }}: <b>{{ $userName }}</b><br>
                                            <b>{{ CustomTranslator::get('Клиент') }}: </b>{{ $whName }}</span>
                                        @endif
                                    </div>
                                </td>
                            </tr>
            ...
            @else
                ...
                <div class="alert alert-warning" role="alert">
                    <a href="{{ route('platform.warehouses.places.index') }}">{{ CustomTranslator::get('У вас не заведен ни один стол упаковки! Чтобы начать упаковку, пожалуйста создайте хотя бы один!') }}</a>
                </div>
